  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Home Automation System - Elevate your living experience with seamless control over your home devices, right from your mobile, no matter where you are in the world."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1530546171585-cc042ea5d7ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxob21lJTIwYXV0b21hdGlvbnxlbnwwfHx8fDE2OTc2OTQwODZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Home Automation System - Elevate your living experience with seamless control over your home devices, right from your mobile, no matter where you are in the world.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Home Owner" type="home-owner" abilities={appConfig.ownerAbilities} />
