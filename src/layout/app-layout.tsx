...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['home-owner', 'family-member', 'property-manager', 'service-provider'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Homes', path: '/homes', entity: 'home', service: AccessServiceEnum.PROJECT, icon: FiHome },
    {
      name: 'Home Devices',
      path: '/home-devices',
      entity: 'home_device',
